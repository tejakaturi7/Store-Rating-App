...
function OwnerSignup() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      await axios.post("http://localhost:5001/api/auth/owner/signup", form);
  ...
  return (
    <div style={styles.container}>
      <div style={styles.card}>
        <h2 style={styles.title}>🏪 Owner Signup</h2>
        <p style={styles.subtitle}>Create an account to manage your stores efficiently.</p>
